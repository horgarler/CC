...
public class InventorXx1CreateTest extends TestHarness{
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/xx1/create-negative-optionless.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	public void negativeTestOptionless(final String code, final String items, final String xx3, final String xx4, final String xx51, 
		final String xx52,	final String xx6, final String xx7) {
